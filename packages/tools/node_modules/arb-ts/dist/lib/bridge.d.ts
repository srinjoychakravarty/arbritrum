...
export declare class Bridge extends L2Bridge {
    ...
    depositAsERC20(erc20L1Address: string, amount: BigNumber, maxGas: BigNumber, gasPriceBid: BigNumber, destinationAddress?: string, overrides?: TransactionOverrides): Promise<ethers.ContractTransaction>;
    depositAsERC777(erc20L1Address: string, amount: BigNumber, maxGas: BigNumber, gasPriceBid: BigNumber, destinationAddress?: string, overrides?: TransactionOverrides): Promise<ethers.ContractTransaction>;
    ...
    getDepositTokenEventData(l1Transaction: ethers.providers.TransactionReceipt, tokenType?: 'ERC20' | 'ERC777'): Promise<import("./bridge_helpers").DepositTokenEventResult[]>;
