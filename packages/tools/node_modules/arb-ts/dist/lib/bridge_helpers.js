...
var BridgeHelper = /** @class */ (function () {
    ...
    BridgeHelper.getDepositTokenEventData = function (l1Transaction, tokenType, l2BridgeAddress) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                contract = factory.attach(l2BridgeAddress || 'l2BridgeAddr');
                iface = contract.interface;
    ...
    BridgeHelper.getWithdrawalsInL2Transaction = function (l2Transaction, l2Provider, arbSysAddress) { return __awaiter(void 0, void 0, void 0, function () {
        var contract, iface, l2ToL1Event, eventTopic, logs;
        return __generator(this, function (_a) {
            contract = ArbSys__factory_1.ArbSys__factory.connect(arbSysAddress || 'arbSysAddress', l2Provider);
            iface = contract.interface;
    ...
    BridgeHelper.getInboxSeqNumFromContractTransaction = function (l2Transaction, inboxAddress) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            contract = factory.attach(inboxAddress || 'inboxAddress');
            iface = contract.interface;
    ...
    BridgeHelper.getL2ToL1EventData = function (destinationAddress, l2Provider, arbSysAddress) { return __awaiter(void 0, void 0, void 0, function () {
