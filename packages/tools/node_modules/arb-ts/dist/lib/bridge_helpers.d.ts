...
export declare class BridgeHelper {
    ...
    static getDepositTokenEventData: (l1Transaction: providers.TransactionReceipt, tokenType?: 'ERC20' | 'ERC777', l2BridgeAddress?: string | undefined) => Promise<Array<DepositTokenEventResult>>;
    static getWithdrawalsInL2Transaction: (l2Transaction: providers.TransactionReceipt, l2Provider: providers.Provider, arbSysAddress?: string | undefined) => Promise<Array<L2ToL1EventResult>>;
    static getCoreBridgeFromInbox: (inboxAddress: string, l1Provider: providers.Provider) => Promise<string>;
    static getInboxSeqNumFromContractTransaction: (l2Transaction: providers.TransactionReceipt, inboxAddress?: string | undefined) => Promise<ethers.BigNumber[] | undefined>;
    ...
    static getL2ToL1EventData: (destinationAddress: string, l2Provider: providers.Provider, arbSysAddress?: string | undefined) => Promise<L2ToL1EventResult[]>;
}
