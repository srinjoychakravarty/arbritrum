...
var Bridge = /** @class */ (function (_super) {
    ...
    Bridge.prototype.depositAsERC20 = function (erc20L1Address, amount, maxGas, gasPriceBid, destinationAddress, overrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.l1Bridge.depositAsERC20(erc20L1Address, amount, maxSubmissionPrice, maxGas, gasPriceBid, destinationAddress, overrides)];
                }
            });
        });
    };
    Bridge.prototype.depositAsERC777 = function (erc20L1Address, amount, maxGas, gasPriceBid, destinationAddress, overrides) {
        return __awaiter(this, void 0, void 0, function () {
            var maxSubmissionPrice;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        maxSubmissionPrice = (_a.sent())[0];
                        return [2 /*return*/, this.l1Bridge.depositAsERC777(erc20L1Address, amount, maxSubmissionPrice, maxGas, gasPriceBid, destinationAddress, overrides)];
                }
            });
        });
    };
    ...
    Bridge.prototype.getWithdrawalsInL2Transaction = function (l2Transaction) {
        return bridge_helpers_1.BridgeHelper.getWithdrawalsInL2Transaction(l2Transaction, this.l2Provider, l2Bridge_1.ARB_SYS_ADDRESS);
    };
    Bridge.prototype.getDepositTokenEventData = function (l1Transaction, tokenType) {
        if (tokenType === void 0) { tokenType = 'ERC20'; }
        return bridge_helpers_1.BridgeHelper.getDepositTokenEventData(l1Transaction, tokenType, this.arbTokenBridge.address);
    };
    ...
    Bridge.prototype.getL2ToL1EventData = function (destinationAddress) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, bridge_helpers_1.BridgeHelper.getL2ToL1EventData(destinationAddress, this.l2Provider, l2Bridge_1.ARB_SYS_ADDRESS)];
            });
        });
    };
    return Bridge;
