...
var StandardArbERC777__factory_1 = require("./abi/factories/StandardArbERC777__factory");
var IArbToken__factory_1 = require("./abi/factories/IArbToken__factory");
...
var L2Bridge = /** @class */ (function () {
    ...
    L2Bridge.prototype.withdrawERC777 = function (erc20l1Address, amount, destinationAddress, overrides) {
        if (overrides === void 0) { overrides = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var destination, _a, tokenData, erc777TokenData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = destinationAddress;
                    ...
                    case 3:
                        ...
                        erc777TokenData = tokenData.ERC777;
                        if (!erc777TokenData) {
                            throw new Error("Can't withdraw; ArbERC777 for " + erc20l1Address + " doesn't exist");
                        }
                        return [2 /*return*/, erc777TokenData.contract.withdraw(destination, amount, overrides)];
                }
            });
        });
    };
    ...
    L2Bridge.prototype.getAndUpdateL2TokenData = function (erc20L1Address) {
        return __awaiter(this, void 0, void 0, function () {
            var tokenData, walletAddress, customTokenAddress, customTokenContract, balance, err_1, l2ERC20Address, l2ERC777Address, arbERC20TokenContract, balance, arbERC20TokenContract, balance, arbERC77TokenContract, balance, arbERC777TokenContract, balance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.arbTokenBridge.customToken(erc20L1Address)];
                    case 2:
                        customTokenAddress = _a.sent();
                        if (!(customTokenAddress !== ethers_1.ethers.constants.AddressZero)) return [3 /*break*/, 6];
                        customTokenContract = IArbToken__factory_1.IArbToken__factory.connect(customTokenAddress, this.l2Signer);
                        tokenData.CUSTOM = {
                    ...
                    case 5:
                        err_1 = _a.sent();
                        console.warn("Count not get custom token's balance", err_1);
                        return [3 /*break*/, 6];
                    case 6: return [4 /*yield*/, this.getERC20L2Address(erc20L1Address)];
                    case 7:
                        l2ERC20Address = _a.sent();
                        return [4 /*yield*/, this.getERC777L2Address(erc20L1Address)
                            // check if standard arb erc20:
                        ];
                    case 8:
                        l2ERC777Address = _a.sent();
                        if (!!tokenData.ERC20) return [3 /*break*/, 14];
                        return [4 /*yield*/, this.l2Provider.getCode(l2ERC20Address)];
                    case 9:
                        if (!((_a.sent()).length > 2)) return [3 /*break*/, 12];
                    ...
                    case 14: return [4 /*yield*/, StandardArbERC20__factory_1.StandardArbERC20__factory.connect(l2ERC20Address, this.l2Signer)];
                    case 15:
                        arbERC20TokenContract = _a.sent();
                        return [4 /*yield*/, arbERC20TokenContract.balanceOf(walletAddress)];
                    case 16:
                        ...
                        _a.label = 17;
                    case 17:
                        if (!!tokenData.ERC777) return [3 /*break*/, 23];
                        return [4 /*yield*/, this.l2Provider.getCode(l2ERC777Address)];
                    case 18:
                        if (!((_a.sent()).length > 2)) return [3 /*break*/, 21];
                        return [4 /*yield*/, StandardArbERC777__factory_1.StandardArbERC777__factory.connect(l2ERC777Address, this.l2Signer)];
                    case 19:
                        arbERC77TokenContract = _a.sent();
                        return [4 /*yield*/, arbERC77TokenContract.balanceOf(walletAddress)];
                    case 20:
                        balance = _a.sent();
                        tokenData.ERC777 = {
                        ...
                        return [3 /*break*/, 22];
                    case 21:
                        console.info("Corresponding ArbERC777 for " + erc20L1Address + " not yet deployed");
                        _a.label = 22;
                    case 22: return [3 /*break*/, 26];
                    case 23: return [4 /*yield*/, StandardArbERC777__factory_1.StandardArbERC777__factory.connect(l2ERC777Address, this.l2Signer)];
                    case 24:
                        arbERC777TokenContract = _a.sent();
                        return [4 /*yield*/, arbERC777TokenContract.balanceOf(walletAddress)];
                    case 25:
                        balance = _a.sent();
    ...
    L2Bridge.prototype.getERC777L2Address = function (erc20L1Address) {
        var _a, _b;
        var address;
        if ((address = (_b = (_a = this.l2Tokens[erc20L1Address]) === null || _a === void 0 ? void 0 : _a.ERC777) === null || _b === void 0 ? void 0 : _b.contract.address)) {
            return address;
        }
