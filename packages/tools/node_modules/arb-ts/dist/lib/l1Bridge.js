...
var L1Bridge = /** @class */ (function () {
    ...
    L1Bridge.prototype.depositAsERC20 = function (erc20L1Address, amount, maxSubmissionCost, maxGas, gasPriceBid, destinationAddress, overrides) {
        if (overrides === void 0) { overrides = {}; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, this.ethERC20Bridge.depositAsERC20(erc20L1Address, destination, amount, maxSubmissionCost, maxGas, gasPriceBid, '0x', overrides)];
                }
            });
        });
    };
    L1Bridge.prototype.depositAsERC777 = function (erc20L1Address, amount, maxSubmissionCost, maxGas, gasPriceBid, destinationAddress, overrides) {
        if (overrides === void 0) { overrides = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var destination, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        destination = _a;
                        return [2 /*return*/, this.ethERC20Bridge.depositAsERC777(erc20L1Address, destination, amount, maxSubmissionCost, maxGas, gasPriceBid, '0x', overrides)];
                }
            });
        });
    };
    L1Bridge.prototype.depositAsCustomToken = function (erc20L1Address, amount, maxSubmissionCost, maxGas, gasPriceBid, destinationAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var destination, _a, customTokenL2Address;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = destinationAddress;
                    ...
                    case 2:
                        destination = _a;
                        return [4 /*yield*/, this.ethERC20Bridge.customL2Tokens(erc20L1Address)];
                    case 3:
                        customTokenL2Address = _b.sent();
                        if (customTokenL2Address === ethers_1.constants.AddressZero) {
                            throw new Error("Custom token at " + erc20L1Address + " not registtered on L2");
                        }
                        return [2 /*return*/, this.ethERC20Bridge.depositAsCustomToken(erc20L1Address, destination, amount, maxSubmissionCost, maxGas, gasPriceBid, '')];
                }
            });
        });
    };
