...
exports.mergeABIs = exports.traverse = exports.traverseMultipleDirectory = exports.processNamedAccounts = exports.addDeployments = exports.deleteDeployments = exports.loadAllDeployments = exports.getExtendedArtifactFromFolder = exports.getArtifactFromFolder = exports.getChainId = void 0;
...
function processNamedAccounts(hre, accounts, chainIdGiven) {
    if (hre.config.namedAccounts) {
        return transformNamedAccounts(hre.config.namedAccounts, chainIdGiven, accounts, process.env.HARDHAT_DEPLOY_ACCOUNTS_NETWORK || hre.network.name);
    }
    else {
        return {
            namedAccounts: {},
